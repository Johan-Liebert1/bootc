...
use crate::{
    bootc_composefs::{
        ...
        status::{
            get_bootloader, get_composefs_status, get_imginfo, get_sorted_grub_uki_boot_entries, get_sorted_type1_boot_entries
        },
    },
...
///
// TODO
// - What happens on upgrade/switch? 
//   - We don't really delete bootloader entries, but we delete image
//   - Start from `delete_composefs_deployment` function as we'd usually want to delete a
//   deployment image, and then do the rest
